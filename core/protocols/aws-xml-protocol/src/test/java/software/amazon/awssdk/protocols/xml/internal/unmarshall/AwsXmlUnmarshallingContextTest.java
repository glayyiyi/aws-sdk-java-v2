...
public class AwsXmlUnmarshallingContextTest {
    ...
    private static final ExecutionAttributes EXECUTION_ATTRIBUTES_1 =
        new ExecutionAttributes().putAttribute(SdkInternalExecutionAttribute.EXECUTION_ATTEMPT, 1);
    private static final ExecutionAttributes EXECUTION_ATTRIBUTES_2 =
        new ExecutionAttributes().putAttribute(SdkInternalExecutionAttribute.EXECUTION_ATTEMPT, 2);
    ...
    public void builder_minimal() {
        ...
        assertThat(result.responseIsSuccess()).isNull();
    ...
    public void builder_maximal() {
        ...
        assertThat(result.responseIsSuccess()).isTrue();
    ...
    public void equals_maximal_negative() {
        assertThat(maximal().toBuilder().responseIsSuccess(false).build()).isNotEqualTo(maximal());
    ...
    public void hashcode_maximal_negative() {
        assertThat(maximal().toBuilder().responseIsSuccess(false).build().hashCode())
