...
public class AwsXmlUnmarshallingContext {
    ...
    private final Boolean responseIsSuccess;
    ...
    private AwsXmlUnmarshallingContext(Builder builder) {
        ...
        this.responseIsSuccess = builder.responseIsSuccess;
    ...
    public Builder toBuilder() {
        return builder().sdkHttpFullResponse(this.sdkHttpFullResponse)
                        ...
                        .responseIsSuccess(this.responseIsSuccess)
    ...
    public boolean equals(Object o) {
        ...
        if (responseIsSuccess != null ? ! responseIsSuccess.equals(that.responseIsSuccess) :
            that.responseIsSuccess != null) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = 31 * result + (responseIsSuccess != null ? responseIsSuccess.hashCode() : 0);
    ...
    public static final class Builder {
        ...
        public Builder responseIsSuccess(Boolean responseIsSuccess) {
